        ...
        <div className="rounded-lg border border-border bg-surface p-6">
          ...
          {authConfig?.sso_enabled && (
            <>
              ...
              >
                <SSOIcon issuer={authConfig.issuer} />
                Continue with {ssoProviderName(authConfig.issuer)}
              </button>
...
function ssoProviderName(issuer?: string | null): string {
...
function SSOIcon({ issuer }: { issuer?: string | null }) {
  // Google
