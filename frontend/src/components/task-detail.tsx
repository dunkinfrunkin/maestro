              ...
              {runs.map((run) => (
                <div key={run.id} className="flex gap-3">
                  ...
                  <div className="flex-1 pb-4">
                    ...
                    {run.summary && (
                      <div className="text-xs bg-background rounded-md border border-border p-2 mt-1">
                        {run.summary}
                      </div>
                    )}
                    {run.error && (
                      <div className="text-xs bg-red-50 text-red-700 rounded-md border border-red-200 p-2 mt-1">
                        {run.error}
                      </div>
                    )}
                    {run.cost_usd > 0 && (
