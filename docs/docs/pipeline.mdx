...
```mermaid
graph LR
  S["Synced"] --> A["Assigned"] --> I["Implement"] --> R["Review"] --> RP["Risk"] --> HG["Gate"] --> D["Deploy"] --> M["Monitor"] --> DN["Done"]
  R -- "changes" --> I

  style S fill:#ebe5d9,stroke:#6b5b3e,stroke-width:2px,color:#2c2416
  style A fill:#ebe5d9,stroke:#6b5b3e,stroke-width:2px,color:#2c2416
  style I fill:#fef3e2,stroke:#b45309,stroke-width:2.5px,color:#b45309
  style R fill:#fef3e2,stroke:#b45309,stroke-width:2.5px,color:#b45309
  ...
  style M fill:#ebe5d9,stroke:#6b5b3e,stroke-width:2px,color:#2c2416
  style DN fill:#ebe5d9,stroke:#6b5b3e,stroke-width:2.5px,color:#2c2416
  ...
  linkStyle 7 stroke:#2c2416,stroke-width:2px
  linkStyle 8 stroke:#2c2416,stroke-width:2px
  linkStyle 9 stroke:#b45309,stroke-width:2px,stroke-dasharray:5 3
```
